          ...
          {selectedMed && (
            <div className="space-y-6">
              <div className="text-center">
                <p className="text-xl font-semibold">{selectedMed.name}</p>
                <p className="text-muted-foreground">${selectedMed.price} per unit</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <Input
                    type="number"
                    value={quantity}
                    onChange={e => setQuantity(Math.min(selectedMed.stock_quantity, Math.max(1, parseInt(e.target.value) || 1)))}
                ...
                <p className="text-sm text-muted-foreground text-center">{selectedMed.stock_quantity} available</p>
              </div>

              <div className="p-4 rounded-lg bg-muted text-center">
                <p className="text-sm text-muted-foreground">Total Amount</p>
                <p className="text-2xl font-bold">${(selectedMed.price * quantity).toFixed(2)}</p>
              </div>

              <Button onClick={handleSale} className="w-full" disabled={quantity > selectedMed.stock_quantity}>
...
export default StaffRecordSale;
